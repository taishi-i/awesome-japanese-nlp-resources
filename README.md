 ...
 * [ponys-ai-character-consistency-benchmark](https://github.com/wujoe132/ponys-ai-character-consistency-benchmark) - 日本語を含む7言語でAIキャラクターの長期記憶、人格、関係状態、視覚的同一性を評価する事前登録済み140ケースのプロトコル（結果は未収集、[公式サイト](https://ponys.ai/)）。
