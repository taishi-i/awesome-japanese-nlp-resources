...
このリストには、450件の日本語NLPリポジトリが含まれています。
...
[English](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/README.en.md) | [日本語 (Japanese) ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/README.ja.md) | [繁體中文 (Chinese) ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/README.zh-hant.md) | [简体中文 (Chinese) ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/README.zh-hans.md)

各リポジトリの説明文は、機械翻訳モデル（[facebook/nllb-200-distilled-1.3B](https://huggingface.co/facebook/nllb-200-distilled-1.3B)）により翻訳されています。
 ...
 * [jvs_hiho](https://github.com/Hiroshiba/jvs_hiho) - JVS (日本語多彩な言葉) コーパスの自作のラベル
