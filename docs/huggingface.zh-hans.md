...
此页面列出了注册在 [Haggingface](https://huggingface.co) 的专用于日本NLP的模型和数据集。目前，列出了1493个模型和659个数据集。
...
- [NandemoGHS/Anime-Llasa-3B-Captions](https://huggingface.co/NandemoGHS/Anime-Llasa-3B-Captions)
  - Anime-Llasa-3B-Captions 概述 这是 Anime-Llasa-3B-Captions，一个专为日语微调的文本转语音（TTS）模型，基于 NandemoGHS/Anime-Llasa-3B。
...
- [sbintuitions/sarashina2.2-vision-3b](https://huggingface.co/sbintuitions/sarashina2.2-vision-3b)
  - Sarashina2.2-Vision-3B是由SB Intuitions训练的日语大型视觉语言模型。
...
- [tatsuyaaaaaaa/LFM2-VL-3B-gguf](https://huggingface.co/tatsuyaaaaaaa/LFM2-VL-3B-gguf)
  - LiquidAI的LFM2-VL-3B已经转换为gguf格式了。
...
- [jzhang533/PaddleOCR-VL-For-Manga](https://huggingface.co/jzhang533/PaddleOCR-VL-For-Manga)
  - PaddleOCR-VL-For-Manga模型描述 PaddleOCR-VL-For-Manga是一个专为日本漫画文本识别而优化的OCR模型。
...
- [turing-motors/Heron-NVILA-Lite-15B-hf](https://huggingface.co/turing-motors/Heron-NVILA-Lite-15B-hf)
  - Heron-NVILA-Lite-15B是一个基于NVILA-Lite架构训练的用于日语的视觉语言模型。
...
- [mmnga/ELYZA-Thinking-1.0-Qwen-32B-gguf](https://huggingface.co/mmnga/ELYZA-Thinking-1.0-Qwen-32B-gguf)
  - ELYZA-Thinking-1.0-Qwen-32B-gguf是由Elyza发布的gguf格式版本的ELYZA-Thinking-1.0-Qwen-32B。
...
- [John1604/John1604-strongperson-negotiate-japanese-gguf](https://huggingface.co/John1604/John1604-strongperson-negotiate-japanese-gguf)
  - 在 ollama 中使用这个模型。首先下载并安装 ollama。
...
- [LiquidAI/LFM2-350M-PII-Extract-JP](https://huggingface.co/LiquidAI/LFM2-350M-PII-Extract-JP)
  - 游乐场 游乐场 游乐场 跃 Leap （点击这里查看日语版本） LFM2-350M-PII-Extract-JP 基于 LFM2-350M，这个检查点旨在从日文文本中提取个人身份信息（PII）并以 JSON 格式输出。
...
- [SIP-med-LLM/SIP-jmed-llm-3-8x13b-AC-32k-instruct](https://huggingface.co/SIP-med-LLM/SIP-jmed-llm-3-8x13b-AC-32k-instruct)
  - 这个模型是在战略性创新创造计划（SIP）第3期课题“在构建综合卫生保健系统中应用生成人工智能”主题1“开发和社会实施具有安全性和可靠性的开放式医疗LLM”的研究开发中开发的，供研究用途限定、商业用途不可用的医疗专用
...
- [nineninesix/kani-tts-370m-expo2025-osaka-ja](https://huggingface.co/nineninesix/kani-tts-370m-expo2025-osaka-ja)
  - KaniTTS EXPO2025 大阪 日语 是一款专为实时对话人工智能应用进行优化的高速、高保真度的文本转语音模型。
...
- [Aratako/sarashina2.2-3b-RP-v0.2-GGUF](https://huggingface.co/Aratako/sarashina2.2-3b-RP-v0.2-GGUF)
  - 这是Aratako/sarashina2.2-3b-RP-v0.2的GGUF量子化模型概述。
...
- [ronantakizawa/sarashina2-7b-jreadability](https://huggingface.co/ronantakizawa/sarashina2-7b-jreadability)
  - Sarashina2-7B难度平衡日文文本生成，具有难度控制，经过微调以实现具有平衡学习和零简单文本退化的关注难度的日文文本生成🎯
...
- [NandemoGHS/Anime-Speech-Japanese-Captioner-FP8-DYNAMIC](https://huggingface.co/NandemoGHS/Anime-Speech-Japanese-Captioner-FP8-DYNAMIC)
  - Anime-Speech-Japanese-Captioner-FP8-DYNAMIC动漫-日语实时字幕-FP8动态
...
- [shisa-ai/shisa-v2.1c-lfm2-350m](https://huggingface.co/shisa-ai/shisa-v2.1c-lfm2-350m)
  - shisa-ai/shisa-v2.1c-lfm2-350m SOTA 日语 Shaberi Benchmarks 模型卡，适用于小于0.5B和小于1B的数据！
...
- [prj-beatrice/japanese-hubert-base-phoneme-ctc-v4](https://huggingface.co/prj-beatrice/japanese-hubert-base-phoneme-ctc-v4)
  - 基于 rinna/japanese-hubert-base 模型的 CTC 日语音素识别微调版本。
...
- [Alfaxad/LFM2-VL-1.6B-JP](https://huggingface.co/Alfaxad/LFM2-VL-1.6B-JP)
  - LFM2-VL-1.6B-jp（日文）模型描述 LFM2-VL-1.6B-jp 是 LiquidAI/LFM2-VL-1.6B 的日文微调变种，专为日语视觉-语言任务进行了优化。
...
- [Alfaxad/LFM2-VL-450M-jp](https://huggingface.co/Alfaxad/LFM2-VL-450M-jp)
  - LFM2-VL-450M-jp（日本语）模型描述 LFM2-VL-450M-jp 是 LiquidAI/LFM2-VL-450M 的日本优化语版本，专为日本视觉语言任务而设计。
...
- [NandemoGHS/Anime-Llasa-3B-FP8](https://huggingface.co/NandemoGHS/Anime-Llasa-3B-FP8)
  - Anime-Llasa-3B-FP8 这是 NandemoGHS/Anime-Llasa-3B 的 FP8 量化版本。
...
- [Akimite/Gemma3-12b-it-Girl-v3](https://huggingface.co/Akimite/Gemma3-12b-it-Girl-v3)
  - 在调整过程中，由于GPU内存的限制，我们使用了仅提取文本的基础模型。
...
- [ronantakizawa/sarashina2-7b-abliterated](https://huggingface.co/ronantakizawa/sarashina2-7b-abliterated)
  - ronantakizawa/sarashina2-7b-abliterated 这是本书经过删节后的版本（拒绝去除）
...
- [pfnet/Preferred-MedRECT-32B](https://huggingface.co/pfnet/Preferred-MedRECT-32B)
  - Preferred-MedRECT-32B模型描述 Preferred-MedRECT-32B是基于Qwen/Qwen3-32B进行微调的模型，经过LoRA（Low-Rank Adaptation）优化，专为医疗错误检测和校正任务而设计。
...
- [nvidia/Nemotron-Personas-Japan](https://huggingface.co/datasets/nvidia/Nemotron-Personas-Japan)
  - Nemotron-Personas-Japan是根据现实世界的分布生成人设的复合AI方法 数据集概述 Nemotron-Personas-Japan旨在捕捉日本人口的多样性和丰富性，并基于现实世界的人口统计、地理分布和性格特征的分布合成生成的人设的开源数据集。
...
- [ronantakizawa/japanese-text-difficulty](https://huggingface.co/datasets/ronantakizawa/japanese-text-difficulty)
  - 青空文库文本难度数据集 这个数据集包含了日本文学作品，是从青空文库数字图书馆中获取的，增加了基于jReadability的日语语言学习和课程发展的难度分析。
...
- [ronantakizawa/japanese-character-difficulty](https://huggingface.co/datasets/ronantakizawa/japanese-character-difficulty)
  - 综合数据集，包含了3003个日语汉字以及它们的教育难度等级，数据来源于官方的日本教育标准和kanjiapi.dev。
...
- [deepghs/anime_eye_detection](https://huggingface.co/datasets/deepghs/anime_eye_detection)
  - 动漫眼睛检测数据集概要 该资料库提供了一个与Ultralytics兼容的数据集，专门用于动漫角色眼睛检测。
...
- [OsakanaTeishoku/magpie-sft-v1.0-10k-gpt-oss-120b](https://huggingface.co/datasets/OsakanaTeishoku/magpie-sft-v1.0-10k-gpt-oss-120b)
  - llm-jp/magpie-sft-v1.0中的10,000个答复是使用openai/gpt-oss-120b再生成的。
...
- [kenken111/nareba1691](https://huggingface.co/datasets/kenken111/nareba1691)
  - 这个数据集是在对OpenAI公司的GPT-3.5进行 https://huggingface.co/datasets/kenkensz9/kenkensz9_1242tw2 的数据进行微调后，再使用额外收集的330个有个性的推文进行微调的模型生成推文，并对其进行评分的模型。
