...
此页面列出了注册在 [Haggingface](https://huggingface.co) 的专用于日本NLP的模型和数据集。目前，列出了877个模型和174个数据集。
...
- [QuantFactory/Llama-3-EZO-8b-Common-it-GGUF](https://huggingface.co/QuantFactory/Llama-3-EZO-8b-Common-it-GGUF)
  - 量化工厂/Llama-3-EZO-8b-Common-it-GGUF这是使用llama.cpp创建的 HODACHI/Llama-3-EZO-8b-Common-it 的量化版本原始模型卡[LLama-3-EZO 模型卡]基于 meta-llama/Meta-Llama-3-8B-Instruct，通过额外的预训练和指导调整增强了日语的使用。
  - Downloads: 595
...
- [gsarti/opus-mt-tc-base-en-ja](https://huggingface.co/gsarti/opus-mt-tc-base-en-ja)
  - Opus Tatoeba 英日语言模型是通过运行 convert_marian_to_pytorch.py 脚本获得的。
  - Downloads: 19
...
- [nitky/Megac4ai-command-r-plus](https://huggingface.co/nitky/Megac4ai-command-r-plus)
  - Megac4ai-command-r-plusGGUF版本已经发布。
  - Downloads: 18
...
- [atsuki-yamaguchi/bloom-1b1-clpp-ja](https://huggingface.co/atsuki-yamaguchi/bloom-1b1-clpp-ja)
  - BLOOM-1B日语[LAPT + CLP+]如何使用from peft import AutoPeftModelForCausalLMfrom transformers import AutoTokenizermodel = AutoPeftModelForCausalLM.from_pretrained("atsuki-yamaguchi/bloom-1b1-clpp-ja")
  - Downloads: 17
...
- [Aratako/ELYZA-japanese-Llama-2-MoE-2x13B-v0.1-GGUF](https://huggingface.co/Aratako/ELYZA-japanese-Llama-2-MoE-2x13B-v0.1-GGUF)
  ...
  - Downloads: 12
- [atsuki-yamaguchi/bloom-1b1-heuristics-ja](https://huggingface.co/atsuki-yamaguchi/bloom-1b1-heuristics-ja)
  - BLOOM-1B日语[LAPT + 启发] 如何使用 from peft import AutoPeftModelForCausalLM from transformers import AutoTokenizer model = AutoPeftModelForCausalLM.from_pretrained("atsuki-yamaguchi/bloom-1b1-heuristics-ja")
  - Downloads: 12
- [sosoai/Orion-14B-Chat-safetensors](https://huggingface.co/sosoai/Orion-14B-Chat-safetensors)
  - 猎户座-14B🌐英文 | 🇨🇳中文 | 🇯🇵日文 | 🇰🇷韩文🤗
  - Downloads: 12
...
- [Hemimoon/JaTextRel](https://huggingface.co/datasets/Hemimoon/JaTextRel)
  - 关于这个数据集：这个数据集是为了训练和验证用于检索增强生成（Retrieval Augmented Generation, RAG）系统的日语文本嵌入模型而创建的。
  - Downloads: 18
