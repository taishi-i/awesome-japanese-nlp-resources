...
このリストには、492件の日本語NLPリポジトリが含まれています。
...
日本語LLMの情報に関しては、[llm-jp/awesome-japanese-llm](https://github.com/llm-jp/awesome-japanese-llm)をご確認ください。このページでは、オープンソースの GitHub リポジトリ情報を掲載します。
