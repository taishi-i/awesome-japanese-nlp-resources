...
- [列出了881个GitHub仓库的信息 ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/README.zh-hans.md)
- [列出了352个Hugging Face仓库的信息（模型和数据集） ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/huggingface.zh-hans.md) を掲載中
...
```shell
/awesome-japanese-nlp-resources:search 学习日语 NLP 的初学者推荐哪些教程?
```
...
| 使用场景 | 推荐资源 | 热门度 | 理由 |
|---|---|---|---|
| 从零开始学习现代 NLP/LLM 概念 | [llm-book](https://github.com/ghmagazine/llm-book) | ⭐387 | 最热门的入门书;以实用的日语代码示例全面介绍 LLM |
| 通过练习掌握实战技能 | [nlp100v2025](https://github.com/upura/nlp100v2025) | ⭐82 | 经典的"100 题"挑战系列;边做边学的最佳途径 |
| 学习 BERT 与基于 Transformer 的 NLP | [bert-book](https://github.com/stockmarkteam/bert-book) | ⭐262 | 为日语 NLP 初学者提供清晰易懂的 BERT 编程实战教学 |

完整文档请参阅 [插件 README](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/plugins/awesome-japanese-nlp-resources/README.md)。
...
**Python**
 * [novel2hermes_jp](https://github.com/kgmkm/novel2hermes_jp) - 利用强大的内存功能的hermes-agent和擅长日语搜索的外部内存vecmemori，以及用于策划/概念/撰写长篇小说的skills.md。

**Rust**
 * [mecab-dic-converter](https://github.com/tomokane/mecab-dic-converter) - 这是一个用于读取MeCab预编译词典，进行解析和重建，最终转换为可用于Vibrato或Lindera等Mecab兼容tokenizer的字典的Rust crate。
 ...
 * [shirabe-address-api](https://github.com/techwell-inc-jp/shirabe-address-api) - Shirabe地址API - 为AI代理进行日本地址规范化（Cloudflare Workers + Fly.io NRT，支持abr-geocoder）Shirabe地址API - 为AI代理进行日本地址规范化（Cloudflare Workers + Fly.io NRT，支持abr-geocoder）
 * [medical-paper-summarizer-public](https://github.com/yush02084/medical-paper-summarizer-public) - 每日从PubMed自动收集最新的心血管内科论文并进行AI摘要，发送至Gmail的系统
 * [Irodori-TTS](https://github.com/Aratako/Irodori-TTS) - 基于流匹配的文本到语音模型，带有表情符号驱动的风格控制
 * [sarashina2.2-tts](https://github.com/sbintuitions/sarashina2.2-tts) - Sarashina2.2-TTS是一个基于大型语言模型开发的日本中心的文本到语音系统，由SB Intuitions开发。
 * [manga-translator](https://github.com/Detopall/manga-translator) - 一个漫画翻译器，使用Yolov8、manga_ocr和deep-translator创建。
 ...
 * [mecrab](https://github.com/cool-japan/mecrab) - 一个纯Rust实现的形态分析器，与MeCab字典（IPADIC格式）兼容。
 ...
 * [sqlite-vaporetto](https://github.com/hotchpotch/sqlite-vaporetto) - 使用SQLite FTS5扩展实现快速的日文全文搜索，带有🛥Vaporetto / Vaporetto
 * [duckdb-vaporetto](https://github.com/hotchpotch/duckdb-vaporetto) - DuckDB扩展功能，可实现日本全文搜索，使用🛥Vaporetto / Vaporetto による DuckDB + 日本語全文検索拡張機能
 * [lindera-sqlite](https://github.com/lindera/lindera-sqlite) - Lindera为SQLite FTS5扩展
 ...
 * [sudachi-synonyms-dictionary](https://github.com/azu/sudachi-synonyms-dictionary) - 酸橙的同义词词典
 ...
 * [jmdict-fst](https://github.com/theGlenn/jmdict-fst) - 快速JMdict查找引擎，具有基于FST的精确/前缀/模糊/注释搜索，去词尾，Rust核心，以及Swift/Kotlin/Flutter绑定。
 * [mzimeja](https://github.com/katahiromz/mzimeja) - MZ-IME Windows版日文输入法
 ...
 * [japanese-llm-benchmark](https://github.com/shi3z/japanese-llm-benchmark) - 用于评估各种LLM的日语语言能力的基准工具。
 * [EDINET-Bench](https://github.com/SakanaAI/EDINET-Bench) - [ICLR 2026] 评估LLMs在日本具有挑战性的金融任务上的表现。
 * [LCTG-Bench](https://github.com/CyberAgentAILab/LCTG-Bench) - LCTG基准：LLM控制文本生成基准
 * [Kokoro-Speech-Dataset](https://github.com/kaiidams/Kokoro-Speech-Dataset) - 一个公共领域的单人日语演讲数据集
 * [LookVQA](https://github.com/riken-grp/LookVQA) - 一个以凝视为基础的视觉问答数据集，用于澄清模糊的日语问题（LREC-COLING 2024）
 * [JTruthfulQA](https://github.com/nlp-waseda/JTruthfulQA) - JTruthfulQA是TruthfulQA的日本版本（Lin+，2022）。这个数据集并非是从原始的TruthfulQA翻译而来，而是从头开始构建的。
 * [japanese-dataset-for-automated-fact-checking](https://github.com/FujitsuResearch/japanese-dataset-for-automated-fact-checking) - 自动事实核查的日本数据集：JAD-AFC
 ...
 * [nlp-lecture-keio](https://github.com/takamichi-lab/nlp-lecture-keio) - 庆应义塾大学 理工学部 信息工程学科 讲义「自然语言处理」
 * [llm-jp-4-cookbook](https://github.com/llm-jp/llm-jp-4-cookbook) - LLM-jp-4模型的示例脚本
 * [ttslearn](https://github.com/r9y9/ttslearn) - ttslearn: 用于Python的图书馆学习语音合成（使用Python进行文本转语音）
