...
- [列出了886个GitHub仓库的信息 ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/README.zh-hans.md)
- [列出了296个Hugging Face仓库的信息（模型和数据集） ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/huggingface.zh-hans.md) を掲載中
...
| `/awesome-japanese-nlp-resources:similar-resources <repo>` | 给定一个仓库/工具，查找执行相
同或相关处理的仓库 |
...
**Python**
 * [moshi-finetune](https://github.com/nu-dialogue/moshi-finetune) - 使用自己的口语对话数据来微调Moshi/J-Moshi
 * [simple-evals-mm](https://github.com/llm-jp/simple-evals-mm) - 一个轻量级的库，用于在英语和日语基准上评估视觉语言模型。

**Corpus**
 * [kaomoji-data](https://github.com/kaomojikan/kaomoji-data) - 约1,700种日本语表情符号的结构化JSON数据集，包括假名读音（拟态词・关键词）、标签和分类。支持多个分类，按分类分割文件，MIT许可证。
 * [doctrine-corpus](https://github.com/shimo4228/doctrine-corpus) - 双语（日语+英语）判断引发问答语料库（851个示例），编码记录的研究项目决策，每个示例都有元数据（CC0，Hugging Face镜像可用）
 * [medLLM_QA_benchmark](https://github.com/aistairc/medLLM_QA_benchmark) - 医学LLM的三语（英语、日语、中文）QA基准
