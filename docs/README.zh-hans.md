...
- [列出了860个GitHub仓库的信息 ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/README.zh-hans.md)
...
## Claude Code 插件
使用 `awesome-japanese-nlp-search` 插件，直接从 [Claude Code](https://claude.ai/code) 搜索 1,200 多个日语 NLP 资源。
