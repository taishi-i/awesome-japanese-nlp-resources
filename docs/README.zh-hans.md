...
- [列出了823个GitHub仓库的信息 ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/README.zh-hans.md)
- [列出了237个Hugging Face仓库的信息（模型和数据集） ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/huggingface.zh-hans.md) を掲載中
...
**Python**
 * [edinet-mcp](https://github.com/ajtgjmdjp/edinet-mcp) - EDINET XBRL解析库和用于日本金融数据的MCP服务器。

**Corpus**
 * [jfinqa](https://github.com/ajtgjmdjp/jfinqa) - 日本金融问题回答基准，包括来自68家上市公司的1,000个问题。
 * [kotowaza](https://github.com/septn/kotowaza) - 包含日语谚语（kotowaza）的结构化JSON数据集，其中包括印尼语和英语的含义、例子、JLPT级别和标签。
包含日语谚语（kotowaza）的结构化JSON数据集，其中包括印尼语和英语的含义、例子、JLPT级别和标签。
