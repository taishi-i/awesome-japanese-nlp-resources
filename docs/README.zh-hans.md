...
- [列出了857个GitHub仓库的信息 ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/README.zh-hans.md)
- [列出了319个Hugging Face仓库的信息（模型和数据集） ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/huggingface.zh-hans.md) を掲載中
 ...
 * [shirabe-address-api](https://github.com/techwell-inc-jp/shirabe-address-api) - Shirabe地址API - 为AI代理进行日本地址规范化（Cloudflare Workers + Fly.io NRT，支持abr-geocoder）
Shirabe地址API - 为AI代理进行日本地址规范化（Cloudflare Workers + Fly.io NRT，支持abr-geocoder）
