...
- [列出了799个GitHub仓库的信息 ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/README.zh-hans.md)
- [列出了330个Hugging Face仓库的信息（模型和数据集） ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/huggingface.zh-hans.md) を掲載中
...
**Rust**
 * [mojimoji-rs](https://github.com/europeanplaice/mojimoji-rs) - 快速转换日文半角和全角字符的Rust实现，mojimoji。
Rust实现的快速转换器，可在日文半角和全角字符之间转换，mojimoji。
