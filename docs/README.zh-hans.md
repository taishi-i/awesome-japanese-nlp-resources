...
- [列出了901个GitHub仓库的信息 ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/README.zh-hans.md)
- [列出了376个Hugging Face仓库的信息（模型和数据集） ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/huggingface.zh-hans.md)
...
**Rust**
 * [suiko](https://github.com/nwiizo/suiko) - 用Rust CLI可以再现日语文档的自然和易读性，确保诊断结果的确定性。

**Python**
* [bpe2regex](https://github.com/t3tra-dev/bpe2regex) - 将BPE分词器转换为巨大的正则表达式是什么意思？

**Corpus**
 * [aica-corpus](https://github.com/reinehonoka/aica-corpus) - AI角色、填充、笑声、情感表达专用的日语TTS语料库（CC0）
 ...
 * [mecab-python3](https://github.com/SamuraiT/mecab-python3) - mecab-python。您可以在此处找到原始版本：http://taku910.github.io/mecab/。
 ...
 * [moine](https://github.com/tagucci/moine) - 针对日语和普通话的罗马音感知字符串比较。
 * [bpe2regex](https://github.com/t3tra-dev/bpe2regex) - 将BPE分词器转换为巨大的正则表达式是什么意思？
 ...
 * [jp-deinflector](https://github.com/btrkeks/jp-deinflector) - 一个高性能的Rust包，使用完美哈希表对日语单词进行解析
 * [mikke](https://github.com/kimushun1101/mikke) - 日语 Markdown 笔记的本地搜索 CLI 👀 — BM25 全文搜索（SQLite FTS5）+ 可选的本地语义/混合。单一二进制文件，不使用外部 API，适用于 AI 编码代理。
 * [suiko](https://github.com/nwiizo/suiko) - 用Rust CLI可以再现日语文档的自然和易读性，确保诊断结果的确定性。
 ...
 * [pii-ja-ner-onnx-demo](https://github.com/shirokane-suri/pii-ja-ner-onnx-demo) - PII-JA NER 浏览器演示
 ...
 * [jp-pii-detector](https://github.com/baneido/jp-pii-detector) - 日本语个人信息检测器
 ...
 * [jlpt-kanji-dictionary](https://github.com/AnchorI/jlpt-kanji-dictionary) - 结构化的日语汉字和词汇JSON数据集按JLPT级别组织，附有英文和俄文翻译 — 可用于语言学习应用程序、自然语言处理和汉字学习工具。
 * [pfgen-bench](https://github.com/pfnet-research/pfgen-bench) - 首选的一代基准
 * [j-tau-bench](https://github.com/sbintuitions/j-tau-bench) - J-tau：一个用于在真实世界领域中对工具-代理-用户交互进行基准测试的日本tau台。
 * [bbh-ja](https://github.com/pfnet-research/bbh-ja) - BIG-Bench-Hard的日文翻译 (https://github.com/suzgunmirac/BIG-Bench-Hard/)
 * [jfbench](https://github.com/pfnet-research/jfbench) - JFBench：日语指令跟随基准
 * [aica-corpus](https://github.com/reinehonoka/aica-corpus) - AI角色、填充、笑声、情感表达专用的日语TTS语料库（CC0）
