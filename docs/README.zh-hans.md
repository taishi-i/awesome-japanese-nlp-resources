...
[此列表](https://github.com/taishi-i/awesome-japanese-nlp-resources)包含 558 个日语 NLP 存储库。
 ...
 * [qedatasetjaen](https://github.com/tntc-project/qedatasetjaen) - 该存储库包含源语言（日语）和目标语言（英语）文档的单词级翻译质量评估标签。
