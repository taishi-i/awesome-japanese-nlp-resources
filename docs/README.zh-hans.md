...
- [列出了894个GitHub仓库的信息 ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/README.zh-hans.md)
- [列出了311个Hugging Face仓库的信息（模型和数据集） ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/huggingface.zh-hans.md) を掲載中
...
| `/awesome-japanese-nlp-resources:find-new-resources <topic>` | 发现尚未列入清单的 GitHub 仓库和 Hugging Face 模型/数据集 — 贡献辅助工具 |
 ...
 * [medvoice-jp-asr](https://github.com/nikotora/medvoice-jp-asr) - MedVoice-JP LoRA60：日本医疗专用ASR（低语音+ LoRA，60位说话者）和国内首个医疗ASR基准测试（包括完整FT版FT60）

**Corpus**
 * [jvs_nonpara_kana](https://github.com/CyberAgentAILab/jvs_nonpara_kana) - JVS非参数语料库的片假名注释，用于G2P评估

**Dictionary and IME**
 * [rakukan](https://github.com/fukuyori/rakukan) - 使用本地LLM，适用于Windows的日语输入法

**JavaScript**
 * [qmd-ja](https://github.com/joycodetech/qmd-ja) - 增强日语分叉的qmd - 用于准确的日语BM25搜索的Vaporetto WASM形态标记器
日本增强的qmd分叉 - 用于准确的日语BM25搜索的Vaporetto WASM形态标记器
 ...
 * [qmd-ja](https://github.com/joycodetech/qmd-ja) - 增强日语分叉的qmd - 用于准确的日语BM25搜索的Vaporetto WASM形态标记器日本增强的qmd分叉 - 用于准确的日语BM25搜索的Vaporetto WASM形态标记器
