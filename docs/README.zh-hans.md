...
- [列出了313个Hugging Face仓库的信息（模型和数据集） ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/huggingface.zh-hans.md) を掲載中
...
**Rust**
 * [ja-furigana](https://github.com/RyuuNeko1107/ja-furigana) - 处理日语假名（注音）的 Rust 库 + 本地 HTTP 服务器。所有规则都是数据驱动的（TOML）。
