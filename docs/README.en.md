...
**Rust**
 * [ja-furigana](https://github.com/RyuuNeko1107/ja-furigana) - Rust library for handling Japanese furigana (ruby) + local HTTP server. All rules are data-driven (TOML).
