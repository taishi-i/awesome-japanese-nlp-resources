...
**Python**
* [bpe2regex](https://github.com/t3tra-dev/bpe2regex) - I don't understand the meaning of converting BPE tokenizer into a huge regular expression.

**Corpus**
 * [aica-corpus](https://github.com/reinehonoka/aica-corpus) - AI character, filler, laughter, and emotion-focused Japanese TTS corpus (CC0)
 ...
 * [mikke](https://github.com/kimushun1101/mikke) - Local search CLI for Japanese Markdown notes 👀 — BM25 full-text search (SQLite FTS5) + optional local semantic/hybrid. Single binary, no external API usage, for AI coding agents.
 * [suiko](https://github.com/nwiizo/suiko) - 日本語文書の自然さと読みやすさを再現可能に診断するRust CLI / Deterministic diagnostics for natural and readable Japanese writing
 ...
 * [genshijin](https://github.com/interfacex-co-jp/genshijin) - About primitive humans 🗿| Super compressed communication skills for AI agents such as Claude Code / Codex. Optimized for Japanese-specific redundant expressions based on the Japanese version of caveman.
