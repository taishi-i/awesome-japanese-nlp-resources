...
[此列表](https://github.com/taishi-i/awesome-japanese-nlp-resources)包括 567 個日語 NLP 存儲庫。 Hugging Face Spaces 上提供了用於搜索這些存儲庫的[工具](https://huggingface.co/spaces/taishi-i/awesome-japanese-nlp-resources-search)。
