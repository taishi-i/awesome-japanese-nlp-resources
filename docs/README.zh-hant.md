...
- [列出了869個GitHub倉庫的資訊 ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/README.zh-hant.md)
- [列出了371個Hugging Face倉庫的資訊（模型和數據集） ](https://github.com/taishi-i/awesome-japanese-nlp-resources/blob/main/docs/huggingface.zh-hant.md) を掲載中
...
| 使用情境 | 推薦資源 | 熱門程度 | 原因 |
|---|---|---|---|
| 從零開始學習現代 NLP/LLM 概念 | [llm-book](https://github.com/ghmagazine/llm-book) | ⭐387 | 最受歡迎的入門書籍，涵蓋 LLM 端到端內容，並提供實用的日語程式碼範例 |
| 透過練習培養實務技能 | [nlp100v2025](https://github.com/upura/nlp100v2025) | ⭐82 | 經典「100 本敲擊」挑戰系列，透過實作學習的最佳方式 |
| 學習 BERT 與 Transformer 架構的 NLP | [bert-book](https://github.com/stockmarkteam/bert-book) | ⭐262 | 以清晰易懂的說明進行實作 BERT 程式設計，適合日語 NLP 初學者 |
 ...
 * [llm-jp-longbench](https://github.com/llm-jp/llm-jp-longbench) - 為了創建日語版的longbench，我們將利用jemhop數據集。
